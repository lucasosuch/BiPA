...
namespace AlgorytmyDoTTP.Struktura.Algorytmy.Losowy.Wynik
{
    ...
    {
        public WynikGenotypu2Wymiarowego(ReprezentacjaRozwiazania[] listaRozwiazan, ProblemOptymalizacyjny problemOptymalizacyjny) : base(listaRozwiazan, problemOptymalizacyjny)
        {
